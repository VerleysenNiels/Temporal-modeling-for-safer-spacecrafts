...
from Dataset_Exporter import Dataset_Exporter
import numpy as np
import csv
...
BATCH_SIZE = 200
TRAINING_SIZE = 20000
NAME = "Test"                        # Output files will be saved with this name in their respective folders
K = 200                              # Number of previous timesteps as input
M = 100                              # Number of timesteps predicted
architecture_LSTM = [200, 200, 200]  # Define LSTM layers of the network
...
if __name__ == '__main__':
    ...
    # Save this progress
    model.model.save("./Trained/" + str(NAME) + ".hdf5")
